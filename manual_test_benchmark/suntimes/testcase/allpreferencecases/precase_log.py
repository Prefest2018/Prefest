...
try :
	...
	clickInList(driver, 'Set alarm for note')
	time.sleep(1)
	driver.press('back')
	scrollToClickElement(driver, 'Alarms')
	scrollToClickElement(driver, 'Show all ringtones')
	clickOnCheckable(driver, text = 'Show all ringtones',value = True)
	scrollToClickElement(driver, 'Launcher Icon')
	clickOnCheckable(driver, text = 'Launcher Icon',value = False)
