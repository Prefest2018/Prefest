...
try :
	...
	conscript(driver)
	clickOnCheckable(driver, text = 'Mobile Updates',value = True)
	scrollToClickElement(driver, 'Show Download Report')
	conscript(driver)
	clickOnCheckable(driver, text = 'Show Download Report',value = False)
	time.sleep(1)
	driver.press('back')
	...
	conscript(driver)
	clickOnCheckable(driver, text = 'Headphones Disconnect',value = False)
	scrollToClickElement(driver, 'Headphones Reconnect')
	conscript(driver)
	clickOnCheckable(driver, text = 'Headphones Reconnect',value = False)
	scrollToClickElement(driver, 'Bluetooth Reconnect')
	conscript(driver)
	clickOnCheckable(driver, text = 'Bluetooth Reconnect',value = True)
	scrollToClickElement(driver, 'Pause for Interruptions')
	conscript(driver)
	clickOnCheckable(driver, text = 'Pause for Interruptions',value = True)
	scrollToClickElement(driver, 'Resume after Call')
	conscript(driver)
	clickOnCheckable(driver, text = 'Resume after Call',value = False)
	scrollToClickElement(driver, 'Upon exiting video')
	conscript(driver)
	clickInList(driver, 'Continue audio playback')
	conscript(driver)
	scrollToClickElement(driver, 'Forward Button Skips')
	conscript(driver)
	clickOnCheckable(driver, text = 'Forward Button Skips',value = True)
	scrollToClickElement(driver, 'Previous button restarts')
	conscript(driver)
	clickOnCheckable(driver, text = 'Previous button restarts',value = True)
	scrollToClickElement(driver, 'Enqueue Downloaded')
	conscript(driver)
	clickOnCheckable(driver, text = 'Enqueue Downloaded',value = False)
	scrollToClickElement(driver, 'Enqueue at Front')
	conscript(driver)
	clickOnCheckable(driver, text = 'Enqueue at Front',value = True)
	scrollToClickElement(driver, 'Continuous Playback')
	conscript(driver)
	clickOnCheckable(driver, text = 'Continuous Playback',value = False)
	scrollToClickElement(driver, 'Smart Mark as Played')
	conscript(driver)
	clickInList(driver, '300')
	conscript(driver)
	scrollToClickElement(driver, 'Keep Skipped Episodes')
	conscript(driver)
	clickOnCheckable(driver, text = 'Keep Skipped Episodes',value = False)
	scrollToClickElement(driver, 'Media player')
	conscript(driver)
	clickInList(driver, 'Built-in Android player')
	conscript(driver)
	scrollToClickElement(driver, 'Chromecast support')
	conscript(driver)
	clickOnCheckable(driver, text = 'Chromecast support',value = True)
	time.sleep(1)
	driver.press('back')
	...
	conscript(driver)
	clickInList(driver, '20 MiB')
	conscript(driver)
	scrollToClickElement(driver, 'Auto Delete')
	conscript(driver)
	clickOnCheckable(driver, text = 'Auto Delete',value = True)
	scrollToClickElement(driver, 'Keep Favorite Episodes')
	conscript(driver)
	clickOnCheckable(driver, text = 'Keep Favorite Episodes',value = False)
	time.sleep(1)
	driver.press('back')
	...
	conscript(driver)
	clickInList(driver, 'Black (AMOLED ready)')
	conscript(driver)
	scrollToClickElement(driver, 'Set Subscription Order')
	conscript(driver)
	clickInList(driver, 'Sort alphabetically')
	conscript(driver)
	...
	conscript(driver)
	clickOnCheckable(driver, text = 'High Notification priority',value = True)
	scrollToClickElement(driver, 'Persistent Playback Controls')
	conscript(driver)
	clickOnCheckable(driver, text = 'Persistent Playback Controls',value = False)
	scrollToClickElement(driver, 'Set Lockscreen Background')
	conscript(driver)
	clickOnCheckable(driver, text = 'Set Lockscreen Background',value = False)
	scrollToClickElement(driver, 'Back Button Behavior')
	conscript(driver)
	clickInList(driver, 'Open navigation drawer')
	conscript(driver)
