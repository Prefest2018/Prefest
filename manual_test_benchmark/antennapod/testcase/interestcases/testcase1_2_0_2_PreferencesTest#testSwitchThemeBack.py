...
try :
	...
	conscript(driver)
	clickInList(driver, 'Number of downloaded episodes')
	conscript(driver)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_2_PreferencesTest#testSwitchThemeBack_pre\"")
