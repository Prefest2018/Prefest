...
try :
	...
	conscript(driver)
	clickInList(driver, 'Number of unplayed episodes')
	conscript(driver)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"PreferencesTest#testSwitchThemeBack_pre\"")
