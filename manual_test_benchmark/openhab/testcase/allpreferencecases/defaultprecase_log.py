...
try :
	...
	clickOnCheckable(driver, text = 'Demo mode',value = False)
	scrollToClickElement(driver, 'Show all Sitemaps in side menu')
	clickOnCheckable(driver, text = 'Show all Sitemaps in side menu',value = False)
	scrollToClickElement(driver, 'Icon format')
	clickInList(driver, 'Bitmap')
	scrollToClickElement(driver, 'High resolution charts')
	clickOnCheckable(driver, text = 'High resolution charts',value = True)
	scrollToClickElement(driver, 'Theme')
	clickInList(driver, 'Dark mode in battery saver')
	scrollToClickElement(driver, 'Disable display timer')
	clickOnCheckable(driver, text = 'Disable display timer',value = False)
	scrollToClickElement(driver, 'Fullscreen')
	clickOnCheckable(driver, text = 'Fullscreen',value = False)
	scrollToClickElement(driver, 'Screen lock')
	clickInList(driver, 'Off')
	scrollToClickElement(driver, 'Tasker integration')
	clickOnCheckable(driver, text = 'Tasker integration',value = False)
	scrollToClickElement(driver, 'Notification vibration')
	clickInList(driver, 'Off')
	scrollToClickElement(driver, 'Data saver')
	clickOnCheckable(driver, text = 'Data saver',value = False)
	scrollToClickElement(driver, 'Show information for troubleshooting')
	clickOnCheckable(driver, text = 'Show information for troubleshooting',value = False)
