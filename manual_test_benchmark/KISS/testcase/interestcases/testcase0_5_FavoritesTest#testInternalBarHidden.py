...
try :
	...
	conscript(driver)
	clickInList(driver, 'Dark semi-transparent theme')
	conscript(driver)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"FavoritesTest#testInternalBarHidden_pre\"")
