...
try :
	...
	conscript(driver)
	clickInList(driver, 'Accessed frequently recently')
	conscript(driver)
	time.sleep(1)
	driver.press('back')
	...
	conscript(driver)
	clickInList(driver, 'AMOLED dark theme')
	conscript(driver)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"FavoritesTest#testInternalBarHiddenOnSearch_pre\"")
