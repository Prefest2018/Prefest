...
try :
	...
	conscript(driver)
	clickInList(driver, 'Accessed recently first')
	conscript(driver)
	...
	conscript(driver)
	clickInList(driver, 'Semi-transparent theme')
	conscript(driver)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_2_FavoritesTest#testInternalBarDisplayedWhenViewingAllApps_pre\"")
