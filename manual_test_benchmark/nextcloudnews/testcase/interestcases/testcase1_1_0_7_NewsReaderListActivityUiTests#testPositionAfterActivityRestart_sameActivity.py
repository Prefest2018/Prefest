...
try :
	...
	clickOnCheckable(driver, text = 'Skip detailed view and open article in the browser',value = True)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_7_NewsReaderListActivityUiTests#testPositionAfterActivityRestart_sameActivity_pre\"")
