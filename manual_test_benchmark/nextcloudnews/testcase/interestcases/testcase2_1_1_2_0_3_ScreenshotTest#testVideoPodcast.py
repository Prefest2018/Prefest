...
try :
	...
	clickOnCheckable(driver, text = 'Sync on startup',value = True)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_2_0_3_ScreenshotTest#testVideoPodcast_pre\"")
