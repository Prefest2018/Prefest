...
try :
	...
	clickOnCheckable(driver, text = 'Enable in Normal Browsing Mode',value = False)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"ThreeDotMenuTest#refreshPageTest_pre\"")
