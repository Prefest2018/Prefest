...
try :
	...
	conscript(driver)
	clickOnCheckable(driver, text = 'Cloned transactions have current date',value = True)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_9_0_15_MyExpensesCabTest#cloneCommandIncreasesListSize_pre\"")
