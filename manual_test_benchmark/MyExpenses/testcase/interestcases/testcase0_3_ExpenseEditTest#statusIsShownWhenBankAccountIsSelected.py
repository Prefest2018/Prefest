...
try :
	...
	conscript(driver)
	clickInList(driver, 'Only when started from aggregate account.')
	conscript(driver)
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"ExpenseEditTest#statusIsShownWhenBankAccountIsSelected_pre\"")
