...
try :
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Amount',value = True)
	scrollToClickElement(driver, 'Category')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Category',value = True)
	scrollToClickElement(driver, 'Notes')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Notes',value = True)
	scrollToClickElement(driver, 'Account')
	conscript(driver)
	clickInList(driver, 'never')
	conscript(driver)
	scrollToClickElement(driver, 'Payment method')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Payment method',value = True)
	time.sleep(1)
	driver.press('back')
	scrollToClickElement(driver, 'Upon short tap on entry in template list')
	conscript(driver)
	clickInList(driver, 'Apply and save')
	conscript(driver)
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Allow to set exact transaction time.',value = False)
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Allow to set value date in addition to booking date. Transaction time will be hidden. This setting is not applied to cash accounts.',value = True)
	time.sleep(1)
	driver.press('back')
	scrollToClickElement(driver, 'Upon app start, scroll transaction list to current date')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Upon app start, scroll transaction list to current date',value = True)
	scrollToClickElement(driver, 'Enable fast scroll for account list. May lead to incorrect display on some devices')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Enable fast scroll for account list. May lead to incorrect display on some devices',value = True)
	scrollToClickElement(driver, 'Cloned transactions keep original date')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Cloned transactions keep original date',value = False)
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Notify about synchronization progress',value = False)
	scrollToClickElement(driver, 'Sync only when on Wi-Fi')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Sync only when on Wi-Fi',value = True)
	scrollToClickElement(driver, 'Write local changes immediately to backend')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Write local changes immediately to backend',value = False)
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'My accounts',value = True)
	scrollToClickElement(driver, 'My templates')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'My templates',value = True)
	scrollToClickElement(driver, 'Data entry from widgets and shortcuts')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Data entry from widgets and shortcuts',value = True)
	time.sleep(1)
	driver.press('back')
	scrollToClickElement(driver, 'Usage data collection')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Usage data collection',value = False)
	scrollToClickElement(driver, 'Crash reports')
	conscript(driver)
	scrollToClickElement(driver, 'Allow automatic sending of crash reports')
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Allow automatic sending of crash reports',value = False)
	...
	conscript(driver)
	clickInList(driver, 'https://openexchangerates.org')
	conscript(driver)
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Allow communication with https even when certificate is issued to different host. WARNING: this is insecure, only use on private network and at your own risk. This setting is taken into account when you setup a WebDAV backend. Changing it does not affect existing backends.',value = True)
	time.sleep(1)
	driver.press('back')
	...
	conscript(driver)
	conscript(driver)
	clickOnCheckable(driver, text = 'Ads',value = True)
