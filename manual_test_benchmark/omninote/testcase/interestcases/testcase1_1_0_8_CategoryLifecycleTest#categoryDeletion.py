...
try :
	...
	scrollToClickElement(driver, 'Swipe to trash')
	clickOnCheckable(driver, text = 'Swipe to trash',value = True)
	time.sleep(1)
	driver.press('back')
	...
	commond("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_8_CategoryLifecycleTest#categoryDeletion_pre\"")
