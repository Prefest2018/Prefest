...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Automatic Download\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Automatic Download\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Download when not charging\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Enable Wi-Fi filter\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Headphones Disconnect\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Headphones Reconnect\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Headphones Reconnect\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Bluetooth Reconnect\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Bluetooth Reconnect\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Pause for Interruptions\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Pause for Interruptions\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Resume after Call\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Resume after Call\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Upon exiting video\")")
	clickInList(driver, "new UiSelector().text(\"Stop playback\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Forward Button Skips\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Forward Button Skips\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Previous button restarts\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Previous button restarts\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Enqueue Downloaded\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Enqueue Downloaded\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Enqueue at Front\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Enqueue at Front\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Continuous Playback\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Continuous Playback\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"High Notification priority\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Persistent Playback Controls\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Persistent Playback Controls\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Set Lockscreen Background\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Set Lockscreen Background\")", "true")
