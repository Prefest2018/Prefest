...
try :
	...
	TouchAction(driver).long_press(element).release().perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.danoeh.antennapod:id/etxtUsername\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("Username");
	swipe(driver, 0.5, 0.2, 0.5, 0.8)
	element = getElememtBack(driver, "new UiSelector().text(\"Include\")", "new UiSelector().resourceId(\"de.danoeh.antennapod:id/radio_filter_include\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	swipe(driver, 0.5, 0.2, 0.5, 0.8)
	element = getElememt(driver, "new UiSelector().resourceId(\"de.danoeh.antennapod:id/etxtUsername\").className(\"android.widget.EditText\")")
	element.clear()
