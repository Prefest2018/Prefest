...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"When not in queue\")").click()
	...
	driver.press_keycode(4)
	scrollToFindElement(driver, "new UiSelector().text(\"Storage\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Image Cache Size\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"20 MiB\")").click()
	driver.press_keycode(4)
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"5_023_pre\"")
