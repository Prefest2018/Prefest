...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Sort by number of played episodes\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Set Subscription Counter\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Number of new episodes\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Back Button Behavior\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Go to page…\")").click()
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().className(\"android.widget.ImageView\").description(\"Search…\")")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.danoeh.antennapod:id/more\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Clear history\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.danoeh.antennapod:id/search\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("Search…");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.danoeh.antennapod:id/summary\").className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	driver.press_keycode(4)
	driver.press_keycode(4)
