...
try :
	...
	element.clear()
	element.send_keys("");
	element = getElememt(driver, "new UiSelector().className(\"android.widget.ImageView\").instance(8)")
	TouchAction(driver).tap(element).perform()
	...
	element.clear()
	element.send_keys("https://play.google.com/store/apps/details?id=de.ub0r.android.donator");
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	print 'repr(e):\t', repr(e)
