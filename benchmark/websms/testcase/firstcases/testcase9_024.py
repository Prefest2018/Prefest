...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.websms:id/text\").className(\"android.widget.MultiAutoCompleteTextView\")")
	element.clear()
	element.send_keys("12");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.websms:id/text\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("12X");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.websms:id/text\").className(\"android.widget.TextView\").instance(3)")
	element.clear()
	element.send_keys("Restore last message");
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	print 'repr(e):\t', repr(e)
