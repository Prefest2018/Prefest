...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Restore last message\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.websms:id/item_send\").className(\"android.widget.TextView\")")
	TouchAction(driver).long_press(element).release().perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.websms:id/text\").className(\"android.widget.EditText\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"10_006\"")
