...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Reschedule\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Define custom steps\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Define custom steps\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Safe display mode\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Type answer into the card\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Type answer into the card\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Fix for Hebrew vowels\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Fix for Hebrew vowels\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Enable AnkiDroid API\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Enable AnkiDroid API\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Text to speech\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Text to speech\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Lookup dictionary\")")
	clickInList(driver, "new UiSelector().text(\"Aedict\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Chess notation support\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Chess notation support\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"eReader\")")
	clickOnCheckable(driver, "new UiSelector().text(\"eReader\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Double scrolling\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Double scrolling\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"HTML / Javascript Debugging\")")
	clickOnCheckable(driver, "new UiSelector().text(\"HTML / Javascript Debugging\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Enable advanced statistics\")", "true")
	...
	clickInList(driver, "new UiSelector().text(\"Plain\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Use custom sync server\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Fetch media on sync\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Automatic synchronization\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Automatic synchronization\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Deck for new cards\")")
	clickInList(driver, "new UiSelector().text(\"Decide by note type\")")
	...
	clickInList(driver, "new UiSelector().text(\"Always report\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Notify when\")")
	clickInList(driver, "new UiSelector().text(\"More than %d cards due\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Blink light\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	scrollToClickElement(driver, "new UiSelector().text(\"Gestures\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Enable gestures\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Enable gestures\")", "true")
	...
	clickInList(driver, "new UiSelector().text(\"Lookup expression\")")
	...
	clickInList(driver, "new UiSelector().text(\"New cards after reviews\")")
	...
	clickInList(driver, "new UiSelector().text(\"Hide the system bars\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Center align\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Center align\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Show button time\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show button time\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show remaining\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Show ETA\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show ETA\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Black strokes\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Bury related new cards\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Bury related reviews\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	scrollToClickElement(driver, "new UiSelector().text(\"General\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Show answer timer\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show answer timer\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Automatically play audio\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Automatically play audio\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Replay question\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Replay question\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Enable reminder notifications for decks in this deck group\")", "true")
