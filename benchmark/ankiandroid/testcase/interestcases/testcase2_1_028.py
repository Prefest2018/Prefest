...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Type answer into the card\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Type answer into the card\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Text to speech\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Text to speech\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Lookup dictionary\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Eijiro (Web)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"eReader\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"eReader\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"HTML / Javascript Debugging\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"HTML / Javascript Debugging\")", "true")
	driver.press_keycode(4)
	scrollToFindElement(driver, "new UiSelector().text(\"AnkiDroid\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Share feature usage\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Share feature usage\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Notify when\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Pending messages available\")").click()
	driver.press_keycode(4)
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Fullscreen mode\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Hide the system bars\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Center align\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Center align\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Show ETA\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_028_pre\"")
...
try :
	...
	endtime = time.time()
	print 'consumed time:', str(endtime - starttime), 's'
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_028\"")
	jacocotime = time.time()
	print 'jacoco time:', str(jacocotime - endtime), 's'
	driver.quit()
