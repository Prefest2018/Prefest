...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_1_5_023_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"WEEKLY BREAKDOWN\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
