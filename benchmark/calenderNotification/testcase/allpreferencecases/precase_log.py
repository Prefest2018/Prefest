...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Handle e-mail only events\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Handle events with no reminders\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Handle events with no reminders\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Ignore Declined events\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Ignore Declined events\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Ignore Cancelled events\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Ignore Cancelled events\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Ignore all-day events\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Ignore all-day events\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Enable mute\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickInList(driver, "new UiSelector().text(\"Monday\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Use setAlarmClock for reminders\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Use setAlarmClock for reminders\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Use setAlarmClock for events\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Use setAlarmClock for events\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Forward to PebbleAPI\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Forward to PebbleAPI\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Forward reminders to PebbleAPI\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Forward reminders to PebbleAPI\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Event text in the title\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Event text in the title\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"PebbleAPI - only #alarm-s\")")
	clickOnCheckable(driver, "new UiSelector().text(\"PebbleAPI - only #alarm-s\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Use Alarm volume\")", "true")
	...
	clickInList(driver, "new UiSelector().text(\"Single Very Long\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Heads-up Notification\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Mute primary notifications\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Mute LED\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Mute LED\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"View after edit\")", "false")
