...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Apr\")", "new UiSelector().className(\"android.widget.Button\").instance(1)")
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Next\")", "new UiSelector().className(\"android.widget.Button\").instance(7)")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememtBack(driver, "new UiSelector().text(\"55\")", "new UiSelector().className(\"android.widget.Button\").instance(3)")
	TouchAction(driver).long_press(element).release().perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
