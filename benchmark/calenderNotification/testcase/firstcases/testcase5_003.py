...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Cancel\")", "new UiSelector().className(\"android.widget.Button\").instance(6)")
	TouchAction(driver).tap(element).perform()
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"5_003\"")
