...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Fresh Black\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Background refresh interval\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"12 h\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"8_012_pre\"")
