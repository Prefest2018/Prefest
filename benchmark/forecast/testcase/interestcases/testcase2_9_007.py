...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Beaufort wind scale (bft)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Pressure units\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"in Hg\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"9_007_pre\"")
