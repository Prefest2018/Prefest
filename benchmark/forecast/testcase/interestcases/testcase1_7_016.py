...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Inches (in)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Speed units\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Miles per hour (mph)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Pressure units\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"kPa\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Custom Date Format\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Classic Black\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"24 h\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"7_016_pre\"")
