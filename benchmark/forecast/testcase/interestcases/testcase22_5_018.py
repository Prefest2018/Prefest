...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Show temperature only as an integer\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Show temperature only as an integer\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"Length units\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Millimeters (mm)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Speed units\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Meters per second (m/s)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Pressure units\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"hPa\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Theme\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Fresh\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"1 h\")").click()
