...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Beaufort wind scale (bft)\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Pressure units\")")
	clickInList(driver, "new UiSelector().text(\"in Hg\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Theme\")")
	clickInList(driver, "new UiSelector().text(\"Classic Black\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Make widget transparent\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Make widget transparent\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Wind direction format\")")
	clickInList(driver, "new UiSelector().text(\"No indication\")")
	...
	clickInList(driver, "new UiSelector().text(\"12 h\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Update location in background\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Update location in background\")", "true")
