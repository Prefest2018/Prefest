...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Highlight wrong values\")")
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Highlight similar cells\")")
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Fill in notes\")")
	...
	scrollToClickElement(driver, "new UiSelector().text(\"First launch hints\")")
	...
	scrollToClickElement(driver, "new UiSelector().text(\"More settings\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Highlight cell on touch\")")
