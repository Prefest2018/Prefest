...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Bidirectional selection\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_5_1_018_pre\"")
