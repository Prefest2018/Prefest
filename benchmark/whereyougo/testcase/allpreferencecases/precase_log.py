...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Map scale bar\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Scale bar unit\")")
	clickInList(driver, "new UiSelector().text(\"Imperial\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Font size\")")
	clickInList(driver, "new UiSelector().text(\"large\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Full screen mode\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Full screen mode\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Stay awake\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Stay awake\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Cache persistence\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Cache persistence\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Frame rate\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Frame rate\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Tile boundaries\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Tile boundaries\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Tile coordinates\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Tile coordinates\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Water tiles\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Water tiles\")", "true")
	...
	clickInList(driver, "new UiSelector().text(\"Locus (Locus required)\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Save game automatically\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Save game automatically\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Double tap\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Double tap\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Allow GPS\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Beep on GPS fix\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Beep on GPS fix\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Disable when hidden\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Disable when hidden\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Guiding\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Guiding\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
