...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Updates\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"In background\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Reverse\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Reverse\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Default currency\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"EUR\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Currency list\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"USD\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_026_pre\"")
