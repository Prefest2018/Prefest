...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"National Bank of Ukraine\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"7_004_pre\"")
