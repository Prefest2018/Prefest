...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"RUB\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Reverse\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"nanoConverter 0.8.98\")", "new UiSelector().className(\"android.widget.TextView\").instance(15)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Flags icon:- http://famfamfam.comPatterns:- http://noqta.it- http://dinpattern.com- http://squidfingers.com- http://pattrnapp.comIcons:- http://adamwhitcroft.com/batchHow to:- http://stackoverflow.com- http://habrahabr.ruThx:- jadis100, Ant-ON, ramallah, spardaev.WTFPL:Do What The Fuck You Want To Public License.\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
