...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/CoursePLNrate\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("0.5370");
	element = getElememt(driver, "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/CourseCHFrate\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("0.9660");
	element = getElememt(driver, "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/CoursePLNrate\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("18.3768");
