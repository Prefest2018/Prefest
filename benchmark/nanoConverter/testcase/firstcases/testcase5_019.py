...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"User data\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio1\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Central Bank of Azerbaijan\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio5\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Forex\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio7\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"National Bank of Belarus\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio3\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Central Bank of Azerbaijan\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio5\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"European Central Bank\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio6\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Forex\")", "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/radio7\").className(\"android.widget.RadioButton\")")
	TouchAction(driver).tap(element).perform()
