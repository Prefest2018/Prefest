...
try :
	...
	element.clear()
	element.send_keys("1");
	element = getElememt(driver, "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/CourseZARrate\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("14.9871");
	element = getElememt(driver, "new UiSelector().resourceId(\"com.nanoconverter.zlab:id/CourseFOOrate\").className(\"android.widget.EditText\")")
	element.clear()
