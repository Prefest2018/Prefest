...
try :
	...
	clickInList(driver, "new UiSelector().text(\"User data\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Reverse\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Reverse\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Default currency\")")
	clickInList(driver, "new UiSelector().text(\"KGS\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Currency list\")")
	scrollToClickElement(driver, "new UiSelector().text(\"USD\")")
	clickOnCheckable(driver, "new UiSelector().text(\"USD\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"EUR\")")
	clickOnCheckable(driver, "new UiSelector().text(\"EUR\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"CHF\")")
	clickOnCheckable(driver, "new UiSelector().text(\"CHF\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"GBP\")")
	clickOnCheckable(driver, "new UiSelector().text(\"GBP\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"JPY\")")
	clickOnCheckable(driver, "new UiSelector().text(\"JPY\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"UAH\")")
	clickOnCheckable(driver, "new UiSelector().text(\"UAH\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"RUB\")")
	clickOnCheckable(driver, "new UiSelector().text(\"RUB\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"MDL\")")
	clickOnCheckable(driver, "new UiSelector().text(\"MDL\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"BYR\")")
	clickOnCheckable(driver, "new UiSelector().text(\"BYR\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"PLN\")")
	clickOnCheckable(driver, "new UiSelector().text(\"PLN\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"LTL\")")
	clickOnCheckable(driver, "new UiSelector().text(\"LTL\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"LVL\")")
	clickOnCheckable(driver, "new UiSelector().text(\"LVL\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"AZN\")")
	clickOnCheckable(driver, "new UiSelector().text(\"AZN\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"AUD\")")
	clickOnCheckable(driver, "new UiSelector().text(\"AUD\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"AMD\")")
	clickOnCheckable(driver, "new UiSelector().text(\"AMD\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"BGN\")")
	clickOnCheckable(driver, "new UiSelector().text(\"BGN\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"BRL\")")
	clickOnCheckable(driver, "new UiSelector().text(\"BRL\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"HUF\")")
	clickOnCheckable(driver, "new UiSelector().text(\"HUF\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"DKK\")")
	clickOnCheckable(driver, "new UiSelector().text(\"DKK\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"INR\")")
	clickOnCheckable(driver, "new UiSelector().text(\"INR\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"KZT\")")
	clickOnCheckable(driver, "new UiSelector().text(\"KZT\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"CAD\")")
	clickOnCheckable(driver, "new UiSelector().text(\"CAD\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"KGS\")")
	clickOnCheckable(driver, "new UiSelector().text(\"KGS\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"CNY\")")
	clickOnCheckable(driver, "new UiSelector().text(\"CNY\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"NOK\")")
	clickOnCheckable(driver, "new UiSelector().text(\"NOK\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"RON\")")
	clickOnCheckable(driver, "new UiSelector().text(\"RON\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"XDR\")")
	clickOnCheckable(driver, "new UiSelector().text(\"XDR\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"SGD\")")
	clickOnCheckable(driver, "new UiSelector().text(\"SGD\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"TJS\")")
	clickOnCheckable(driver, "new UiSelector().text(\"TJS\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"TRY\")")
	clickOnCheckable(driver, "new UiSelector().text(\"TRY\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"TMT\")")
	clickOnCheckable(driver, "new UiSelector().text(\"TMT\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"UZS\")")
	clickOnCheckable(driver, "new UiSelector().text(\"UZS\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"CZK\")")
	clickOnCheckable(driver, "new UiSelector().text(\"CZK\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"SEK\")")
	clickOnCheckable(driver, "new UiSelector().text(\"SEK\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"ZAR\")")
	clickOnCheckable(driver, "new UiSelector().text(\"ZAR\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"KRW\")")
	clickOnCheckable(driver, "new UiSelector().text(\"KRW\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"FOO\")")
	clickOnCheckable(driver, "new UiSelector().text(\"FOO\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
