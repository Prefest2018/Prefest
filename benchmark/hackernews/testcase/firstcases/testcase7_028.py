...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Guix: An advanced operating system\")", "new UiSelector().className(\"android.widget.TextView\").instance(26)")
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"38 nojvek\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
	TouchAction(driver).tap(element).perform()
