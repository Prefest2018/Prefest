...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"5 comments\")", "new UiSelector().className(\"android.widget.TextView\").instance(25)")
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"io.dwak.holohackernews.app:id/comment_overflow\").className(\"android.widget.ImageButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Comments\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
