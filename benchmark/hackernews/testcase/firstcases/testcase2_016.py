...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"2 days ago\")", "new UiSelector().className(\"android.widget.TextView\").instance(12)")
	...
	element = getElememt(driver, "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
