...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"GoDaddy injecting JavaScript into websites and how to stop it\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
