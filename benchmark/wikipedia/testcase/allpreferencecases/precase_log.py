...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"shareTutorialEnabled\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"feedReadingListsSyncOnboardingCardEnabled\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"showRemoveChineseVariantPrompt\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Warn if leaving Wikipedia Zero\")", "false")
