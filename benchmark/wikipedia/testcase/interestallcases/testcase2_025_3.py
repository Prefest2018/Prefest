...
try :
	...
	clickoncheckable(driver, "new UiSelector().text(\"readingListTutorialEnabled\")", "true")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Uploader unknown\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Uploader unknown\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"United States Court of Appeals for the Ninth Circuit\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).long_press(element).release().perform()
	swipe(driver, 0.5, 0.2, 0.5, 0.8)
