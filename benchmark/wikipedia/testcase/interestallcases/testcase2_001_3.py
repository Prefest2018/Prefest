...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Michael Wise Mosman is the Chief United States District Judge of the United States District Court for the District of Oregon, and is simultaneously serving a 2013-2020 term on the FISA Court. The Oregon native previously served as the United States Attorney for the same district.\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
