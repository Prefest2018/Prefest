...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"8_018_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.asdtm.goodweather:id/forecast.wind_icon\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
