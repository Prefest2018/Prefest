...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"11_029_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Tes\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememt(driver, "new UiSelector().resourceId(\"org.asdtm.goodweather:id/search_src_text\").className(\"android.widget.EditText\")")
	element.clear()
