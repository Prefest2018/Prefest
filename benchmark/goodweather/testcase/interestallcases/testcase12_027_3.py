...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"12_027_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Feedback\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(4)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
