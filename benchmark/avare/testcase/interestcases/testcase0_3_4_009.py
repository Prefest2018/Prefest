...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Reverse Landscape\")")
	...
	clickInList(driver, "new UiSelector().text(\"Green Aircraft\")")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"IFR Area\")", "new UiSelector().className(\"android.widget.CheckedTextView\")")
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"VFR Area California\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
