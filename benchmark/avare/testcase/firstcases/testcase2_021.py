...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"<Destination>\")", "new UiSelector().className(\"android.widget.CheckedTextView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Pan\")", "new UiSelector().className(\"android.widget.Button\").instance(5)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Plate\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"com.ds.avare:id/search_list_image\").className(\"android.widget.ImageView\")")
