...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Ringtone\")")
	settingPref_pref_call_ringtone(driver, "file://HeartBeat")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_5_1_012_pre\"")
