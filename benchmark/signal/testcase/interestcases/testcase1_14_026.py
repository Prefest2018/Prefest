...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Display indicators\")").click()
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Display indicators\")", "true")
	driver.press_keycode(4)
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Enter key sends\")").click()
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Enter key sends\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Chat backups\")").click()
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Chat backups\")", "true")
	driver.press_keycode(4)
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"14_026_pre\"")
...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/footer_insecure_indicator\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	...
	endtime = time.time()
	print 'consumed time:', str(endtime - starttime), 's'
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"14_026\"")
	jacocotime = time.time()
	print 'jacoco time:', str(jacocotime - endtime), 's'
	driver.quit()
