...
try :
	...
	conscript(driver)
	clickOnCheckable(driver, "new UiSelector().text(\"Incognito keyboard\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Read receipts\")")
	conscript(driver)
	clickOnCheckable(driver, "new UiSelector().text(\"Read receipts\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"15_022_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/emoji_toggle\").className(\"android.widget.ImageButton\")")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/scribble_text_button\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/quick_camera_toggle\").className(\"android.widget.ImageButton\")")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/camera_flip_button\").className(\"android.widget.ImageButton\")")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/embedded_text_editor\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("Unsecured SMS");
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	print 'repr(e):\t', repr(e)
	...
	endtime = time.time()
	print 'consumed time:', str(endtime - starttime), 's'
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"15_022\"")
	jacocotime = time.time()
	print 'jacoco time:', str(jacocotime - endtime), 's'
	driver.quit()
