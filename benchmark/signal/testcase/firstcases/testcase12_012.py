...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"RESEND\")", "new UiSelector().className(\"android.widget.Button\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Some issues need your attention.\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Some issues need your attention.\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"12_012\"")
