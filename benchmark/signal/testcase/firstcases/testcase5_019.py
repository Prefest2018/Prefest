...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/send_button\").className(\"android.widget.ImageButton\")")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/menu_context_delete_message\").className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
