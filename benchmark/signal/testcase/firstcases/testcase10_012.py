...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.thoughtcrime.securesms:id/attach_button\").className(\"android.widget.ImageButton\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"10_012\"")
