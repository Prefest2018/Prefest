...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"4_006_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"6:51 AM\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"S\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
