...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"8_027_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Stop the always on screen after some time without interaction to save battery\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
