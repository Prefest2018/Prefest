...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"2_026_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"OFF CF GCD\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
