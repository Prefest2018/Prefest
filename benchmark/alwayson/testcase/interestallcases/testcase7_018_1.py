...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"7_018_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Battery style\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
