...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"7_009_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"W\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"T\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
