...
try :
	...
	time.sleep(1)
	driver.press_keycode(4)
	scrollToClickElement(driver, "new UiSelector().text(\"Brightness\")")
	testingSeekBar(driver, "new UiSelector().text(\"Brightness\")", 0.5)
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_1_6_009_pre\"")
