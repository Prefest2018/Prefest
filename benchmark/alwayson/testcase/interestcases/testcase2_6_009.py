...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Slide out\")").click()
	conscript(driver)
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"6_009_pre\"")
...
try :
	...
	endtime = time.time()
	print 'consumed time:', str(endtime - starttime), 's'
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"6_009\"")
	jacocotime = time.time()
	print 'jacoco time:', str(jacocotime - endtime), 's'
	driver.quit()
