...
try :
	...
	clickInList(driver, "new UiSelector().text(\"While not charging\")")
	conscript(driver)
	scrollToClickElement(driver, "new UiSelector().text(\"Battery rules\")")
	clickInList(driver, "new UiSelector().text(\"90% or higher\")")
	conscript(driver)
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickInList(driver, "new UiSelector().text(\"Landscape (Horizontal)\")")
	conscript(driver)
	scrollToClickElement(driver, "new UiSelector().text(\"Animation\")")
	clickInList(driver, "new UiSelector().text(\"Fade out\")")
	conscript(driver)
	...
	clickInList(driver, "new UiSelector().text(\"Disabled (Not recommended for AMOLED screens)\")")
	conscript(driver)
