...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Both, while charging and while discharging\")").click()
	conscript(driver)
	scrollToFindElement(driver, "new UiSelector().text(\"Battery rules\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"90% or higher\")").click()
	conscript(driver)
	driver.press_keycode(4)
	...
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Allow camera shortcuts\")", "true")
	conscript(driver)
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Shown\")").click()
	conscript(driver)
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Portrait (Vertical)\")").click()
	conscript(driver)
	...
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Notification content\")", "false")
	conscript(driver)
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Disabled (Not recommended for AMOLED screens)\")").click()
	conscript(driver)
	scrollToFindElement(driver, "new UiSelector().text(\"Auto night mode\")").click()
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Auto night mode\")", "true")
	conscript(driver)
	...
	conscript(driver)
	clickoncheckable(driver, "new UiSelector().text(\"Disable volume keys\")", "true")
	conscript(driver)
