...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"4_021_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().className(\"android.widget.EditText\").instance(7)")
	TouchAction(driver).tap(element).perform()
