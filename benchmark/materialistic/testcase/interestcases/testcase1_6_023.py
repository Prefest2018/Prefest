...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Comments\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Color code\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Color code\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"Thread indicator\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Thread indicator\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"On-screen navigation\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Lazy load content\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Vote up\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Swipe right to\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"6_023_pre\"")
