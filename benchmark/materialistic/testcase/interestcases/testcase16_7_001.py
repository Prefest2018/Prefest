...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Use volume navigation\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"7_001_pre\"")
