...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Animate navigation\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Block ads\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Extra large\")").click()
