...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Track and waypoints\")")
	conscript(driver)
	scrollToClickElement(driver, "new UiSelector().text(\"Wireless scan mode\")")
	clickInList(driver, "new UiSelector().text(\"Background scanning\")")
	conscript(driver)
	...
	conscript(driver)
	clickOnCheckable(driver, "new UiSelector().text(\"Save WiFis\")", "true")
