...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/inout\").className(\"android.widget.ImageView\")")
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Call 1231\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"12_001\"")
