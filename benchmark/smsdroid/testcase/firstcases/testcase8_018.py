...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/to\").className(\"android.widget.MultiAutoCompleteTextView\")")
	element.clear()
	element.send_keys("test2312");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/to\").className(\"android.widget.MultiAutoCompleteTextView\")")
	element.clear()
	element.send_keys("12");
	element = getElememtBack(driver, "new UiSelector().text(\"12\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Reply\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"[Paste from clipboard]\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/to\").className(\"android.widget.MultiAutoCompleteTextView\")")
	element.clear()
	element.send_keys("test2312");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/text\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("12stdscs");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/text\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("testdscs");
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/item_send\").className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/text\").className(\"android.widget.EditText\")")
	element.clear()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Call 12\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
