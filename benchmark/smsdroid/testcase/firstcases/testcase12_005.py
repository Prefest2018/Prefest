...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"OK\")", "new UiSelector().className(\"android.widget.Button\").instance(1)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.ub0r.android.smsdroid:id/item_compose\").className(\"android.widget.TextView\")")
	TouchAction(driver).long_press(element).release().perform()
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"12_005\"")
