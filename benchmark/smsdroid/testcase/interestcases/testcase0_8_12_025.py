...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Ignore text color for threads\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Show photo\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show photo\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show full date\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Hide send button\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Hide send button\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Hide restore last message button\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Hide restore last message button\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Hide widget\'s label\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Hide delete all threads\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Hide delete all threads\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show target app\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Decode Decimal NCR\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Decode Decimal NCR\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Activate sender\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Activate sender\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Edit as short message\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Edit as short message\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Hide sender/text\")", "false")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"12_025_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Dascdscs\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Remove from Blacklist\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"7:56 AM\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Forward\")", "new UiSelector().className(\"android.widget.TextView\").instance(5)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	...
	endtime = time.time()
	print 'consumed time:', str(endtime - starttime), 's'
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"12_025\"")
	jacocotime = time.time()
	print 'jacoco time:', str(jacocotime - endtime), 's'
	driver.quit()
