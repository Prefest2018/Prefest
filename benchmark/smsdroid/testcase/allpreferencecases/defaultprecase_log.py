...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Hide message counts\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Only mobile numbers\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Modify received sms\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickInList(driver, "new UiSelector().text(\"Multiple long\")")
	...
	clickInList(driver, "new UiSelector().text(\"Consistently\")")
