...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Open files as new task\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"4_025_pre\"")
