...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Colorize Icons\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Quick access\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Recent files\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Recent files\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Images\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Images\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Videos\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Videos\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Audio\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Audio\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Documents\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Documents\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Apks\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Apks\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show Dividers\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Show Headers\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show Headers\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show Sizes\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Fingerprint\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Custom paths\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Custom paths\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Open files as new task\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Open files as new task\")", "false")
