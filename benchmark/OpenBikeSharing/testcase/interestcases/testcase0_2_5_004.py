...
try :
	...
	clickInList(driver, "new UiSelector().text(\"OpenCycleMap\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"5_004_pre\"")
...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"android:id/home\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"6\")", "new UiSelector().className(\"android.widget.TextView\").instance(20)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"android:id/home\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"Estación de Tren\")", "new UiSelector().className(\"android.widget.TextView\").instance(15)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Station\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"14\")", "new UiSelector().className(\"android.widget.TextView\").instance(32)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
