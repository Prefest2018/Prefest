...
try :
	...
	clickInList(driver, "new UiSelector().text(\"OSMPublicTransport\")")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"6\")", "new UiSelector().className(\"android.widget.TextView\").instance(22)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"11\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
