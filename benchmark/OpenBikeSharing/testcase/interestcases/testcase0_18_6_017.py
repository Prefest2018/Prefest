...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Map layer\")")
	clickInList(driver, "new UiSelector().text(\"Mapnik\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Advanced\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Strip station ID\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Strip station ID\")", "false")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"7\")", "new UiSelector().className(\"android.widget.TextView\").instance(22)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"Aquarium\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"android:id/home\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"8\")", "new UiSelector().className(\"android.widget.TextView\").instance(10)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Station\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"10\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"Torre de Hércules\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
	TouchAction(driver).tap(element).perform()
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"Torre de Hércules\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememtBack(driver, "new UiSelector().text(\"11\")", "new UiSelector().className(\"android.widget.TextView\").instance(14)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Station\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"be.brunoparmentier.openbikesharing.app:id/freeBikesLogo\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	...
	driver.press_keycode(4)
	element = getElememtBack(driver, "new UiSelector().text(\"7\")", "new UiSelector().className(\"android.widget.TextView\").instance(28)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
