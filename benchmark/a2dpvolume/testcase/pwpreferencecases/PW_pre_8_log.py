...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"The service will start as a foreground task with an icon on the notification bar.\")").click()
	conscript(driver)
	...
	scrollToFindElement(driver, "new UiSelector().text(\"15m (45ft)\")").click()
	conscript(driver)
