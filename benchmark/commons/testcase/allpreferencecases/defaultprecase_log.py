...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Attribution-ShareAlike 4.0\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Use external storage\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Use external storage\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Automatically get current location\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Automatically get current location\")", "false")
