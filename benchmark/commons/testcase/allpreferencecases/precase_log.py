...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Default License\")")
	clickInList(driver, "new UiSelector().text(\"CC0\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Use external storage\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Use external storage\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Automatically get current location\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Automatically get current location\")", "true")
