...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Kilometers per gallon\n(KPG)\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"5_015_pre\"")
