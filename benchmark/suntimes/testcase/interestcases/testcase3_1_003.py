...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Show previous note\")").click()
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Set Alarm\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
