...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Swap cards (today/tomorrow)\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"4_002_pre\"")
