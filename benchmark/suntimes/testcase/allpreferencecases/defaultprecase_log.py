...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Upcoming Event\")")
	scrollToClickElement(driver, "new UiSelector().text(\"On Clock Tap:\")")
	clickInList(driver, "new UiSelector().text(\"Set Alarm\")")
	scrollToClickElement(driver, "new UiSelector().text(\"On Date Tap:\")")
	clickInList(driver, "new UiSelector().text(\"Set custom date\")")
	...
	clickInList(driver, "new UiSelector().text(\"5 minutes\")")
