...
try :
	starttime = time.time()
	driver = webdriver.Remote('http://localhost:4723/wd/hub', desired_caps)
	element = getElememtBack(driver, "new UiSelector().text(\"[w] The date is set to a day other than today.\")", "new UiSelector().className(\"android.widget.TextView\").instance(37)")
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"com.forrestguice.suntimeswidget:id/info_time_lightmap\").className(\"android.widget.ImageView\")")
	TouchAction(driver).long_press(element).release().perform()
	...
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"solar noon\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
