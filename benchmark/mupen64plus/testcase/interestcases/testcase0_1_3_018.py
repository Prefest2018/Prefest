...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Bottom right\")")
	...
	clickInList(driver, "new UiSelector().text(\"Custom\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"3_018_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Action bar opacity\")", "new UiSelector().className(\"android.widget.TextView\").instance(11)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
