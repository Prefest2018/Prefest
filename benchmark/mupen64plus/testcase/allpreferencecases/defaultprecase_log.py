...
try :
	...
	clickInList(driver, "new UiSelector().text(\"640 x 480\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Immersive mode\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Fix upside down screen\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"GLideN64 Threaded video\")")
	clickOnCheckable(driver, "new UiSelector().text(\"GLideN64 Threaded video\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Flicker reduction\")")
	clickInList(driver, "new UiSelector().text(\"Auto-detect from phone/tablet model\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Use high priority thread\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Mappable volume keys\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Mappable volume keys\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Use Raphnet adapter raw USB access\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Automatic player mapping\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"All emulated controllers are always attached\")")
	clickOnCheckable(driver, "new UiSelector().text(\"All emulated controllers are always attached\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Share controller\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Share controller\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Haptic feedback\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Animate joystick\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Animate joystick\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Button style\")")
	clickInList(driver, "new UiSelector().text(\"JoshaGibs Style\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Relative touchscreen joystick\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Hide buttons when not used\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Hide buttons when not used\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Time stretch audio\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Floating Point Samples\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Swap audio channels\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Recently played\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Cache recent games\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Cache recent games\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Use flat game data folder structure\")", "false")
