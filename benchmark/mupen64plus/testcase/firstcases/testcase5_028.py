...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Download cover art\")", "new UiSelector().resourceId(\"paulscode.android.mupen64plusae:id/checkBox2\").className(\"android.widget.CheckBox\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Scan subdirectories\")", "new UiSelector().resourceId(\"paulscode.android.mupen64plusae:id/checkBox4\").className(\"android.widget.CheckBox\")")
	TouchAction(driver).tap(element).perform()
