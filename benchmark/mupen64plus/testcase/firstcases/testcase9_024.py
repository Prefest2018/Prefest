...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Idioma\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"CXD4 LLE Video\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"9_024\"")
