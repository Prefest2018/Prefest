...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Language\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Galego\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(7)")
	TouchAction(driver).tap(element).perform()
