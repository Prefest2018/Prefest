...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Ακύρωση\")", "new UiSelector().className(\"android.widget.Button\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Standard\")", "new UiSelector().className(\"android.widget.TextView\").instance(12)")
	TouchAction(driver).tap(element).perform()
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"10_019\"")
