...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"..ge/sdcard/pic4.jpg\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememt(driver, "new UiSelector().className(\"android.widget.ImageButton\").description(\"Mais opções\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Rename\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"de.k3b.android.androFotoFinder:id/edName\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("Michael Mosman District Judge.jpg");
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	print 'repr(e):\t', repr(e)
