...
try :
	...
	element.clear()
	element.send_keys("testtrage/sdcard/copy/log");
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"12st\")", "new UiSelector().className(\"android.widget.EditText\").instance(13)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"android:id/edit\").className(\"android.widget.EditText\")")
	element.clear()
