...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Auto hide actionbar after millisecs\")")
	typeText(driver,"")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"5_027_pre\"")
