...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"http://en.wikipedia.org/\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
	TouchAction(driver).tap(element).perform()
	swipe(driver, 0.5, 0.8, 0.5, 0.2)
	...
	element.clear()
	element.send_keys("12tps://en.m.wikipedia.org/wiki/Main_Page");
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("12sts://en.m.wikipedia.org/wiki/Main_Page");
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/FaviconView\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
