...
try :
	...
	element.clear()
	element.send_keys("https://en.m.wikipedia.org/wiki/Main_Page");
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("tests://en.m.wikipedia.org/wiki/Main_Page#/search");
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("testtesthttps://en.m.wikipedia.org/wiki/Main_Page#/search");
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("testtesthttps://en.m.wikipedia.org/wiki/Main_Page#/search");
	element = getElememt(driver, "new UiSelector().className(\"android.widget.Button\").description(\"Close\")")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("https://en.m.wikipedia.org/wiki/Main_Page#/search");
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/FaviconView\").className(\"android.widget.ImageView\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"https://en.m.wikipedia.org/wiki/Main_Page\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
