...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/SeekBarPreferenceSeekBar\").className(\"android.widget.SeekBar\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Set the minimum font size used to display text in the browser.\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Text size\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/SeekBarPreferenceSeekBar\").className(\"android.widget.SeekBar\")")
	TouchAction(driver).tap(element).perform()
