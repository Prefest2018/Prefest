...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Home page\")")
	settingPref_PREFERENCE_HOME_PAGE(driver, "about:start")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_2_0_5_2_021_pre\"")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"User interface\")", "new UiSelector().className(\"android.widget.TextView\").instance(10)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Select the type of user interface.\")", "new UiSelector().className(\"android.widget.TextView\").instance(12)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Phone\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
