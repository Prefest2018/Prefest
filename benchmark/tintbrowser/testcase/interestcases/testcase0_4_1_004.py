...
try :
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_004_pre\"")
...
try :
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("test://12tp//12st//tests//en.m.wikipedia.org/wiki/Main_Page");
	swipe(driver, 0.5, 0.2, 0.5, 0.8)
	element = getElememt(driver, "new UiSelector().resourceId(\"org.tint:id/UrlBarUrlEdit\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("http://12tp//12st//tests//en.m.wikipedia.org/wiki/Main_Page");
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
	print 'repr(e):\t', repr(e)
