...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Headset control beep\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Pause when unplugged\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickInList(driver, "new UiSelector().text(\"Enqueue\")")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Double tap widget\")", "true")
	...
	clickInList(driver, "new UiSelector().text(\"Enqueue album\")")
	...
	clickInList(driver, "new UiSelector().text(\"Import M3U, never export\")")
	time.sleep(1)
	driver.press_keycode(4)
