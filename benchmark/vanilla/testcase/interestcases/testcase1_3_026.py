...
try :
	...
	clickoncheckable(driver, "new UiSelector().text(\"Headset/Bluetooth controls\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"External output only\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"External output only\")", "true")
	...
	clickoncheckable(driver, "new UiSelector().text(\"Load artwork from hidden folder\")", "false")
	...
	clickoncheckable(driver, "new UiSelector().text(\"Load artwork from file tags\")", "false")
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Expand\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Scroll to track title\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Scroll to track title\")", "true")
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Jump to enqueued song on \'Play\'\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Jump to enqueued song on \'Play\'\")", "false")
	driver.press_keycode(4)
	...
	clickoncheckable(driver, "new UiSelector().text(\"Enable readahead\")", "true")
	driver.press_keycode(4)
