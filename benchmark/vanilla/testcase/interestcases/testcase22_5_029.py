...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Default playlist action\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Enqueue if playing; Play if paused\")").click()
	driver.press_keycode(4)
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"5_029_pre\"")
