...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Skip to next track\")")
	time.sleep(1)
	driver.press_keycode(4)
...
try :
	starttime = time.time()
	driver = webdriver.Remote('http://localhost:4723/wd/hub', desired_caps)
	element = getElememtBack(driver, "new UiSelector().text(\"Test of MP3 File\")", "new UiSelector().className(\"android.widget.TextView\")")
