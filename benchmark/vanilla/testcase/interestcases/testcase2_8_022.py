...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Enqueue\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"8_022_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Remove\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Test of MP3 FileMe, Me\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Play next\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
