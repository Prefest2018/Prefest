...
try :
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Auto-sync only on WiFi\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Sync enabled\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Sync enabled\")", "false")
	...
	clickInList(driver, "new UiSelector().text(\"Every 3 hours\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Upload the database immediately after change\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Upload the database immediately after change\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Sync on start\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Sync on start\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Auto-sync only on WiFi\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Auto-sync only on WiFi\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"View open accounts\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"View favourite accounts\")")
	clickOnCheckable(driver, "new UiSelector().text(\"View favourite accounts\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Shows the balance for each transaction\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Shows the balance for each transaction\")", "false")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Searching by text contents and not by text beginning with\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Process Bank Transaction SMS\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Process Bank Transaction SMS\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"SMS Transaction Status Notification\")")
	clickOnCheckable(driver, "new UiSelector().text(\"SMS Transaction Status Notification\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Show tutorial\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show tutorial\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show simple budget view\")", "false")
