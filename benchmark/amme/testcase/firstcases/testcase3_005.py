...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Transfer\")", "new UiSelector().resourceId(\"com.money.manager.ex:id/checkBoxTransfer\").className(\"android.widget.CheckBox\")")
	TouchAction(driver).tap(element).perform()
