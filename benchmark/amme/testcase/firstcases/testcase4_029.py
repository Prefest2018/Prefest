...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Categories\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
	swipe(driver, 0.5, 0.2, 0.5, 0.8)
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Vacation\")", "new UiSelector().className(\"android.widget.TextView\").instance(18)")
	TouchAction(driver).long_press(element).release().perform()
