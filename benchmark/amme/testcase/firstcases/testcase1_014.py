...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Withdrawal\")", "new UiSelector().resourceId(\"com.money.manager.ex:id/checkBoxWithdrawal\").className(\"android.widget.CheckBox\")")
	TouchAction(driver).tap(element).perform()
