...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Dropbox\")").click()

	driver.press_keycode(4)
	time.sleep(2)
	os.popen("adb shell am start -n com.money.manager.ex/com.money.manager.ex.settings.LookFeelSettingsActivity")
	scrollToFindElement(driver, "new UiSelector().text(\"Hide Reconciled Amounts\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Roboto Light\")").click()

	driver.press_keycode(4)
	time.sleep(2)
	os.popen("adb shell am start -n com.money.manager.ex/com.money.manager.ex.settings.BehaviourSettingsActivity")
	scrollToFindElement(driver, "new UiSelector().text(\"Notification Recurring Transaction overdue\")").click()
