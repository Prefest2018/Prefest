...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Dropbox\")")
	...
	clickInList(driver, "new UiSelector().text(\"Roboto Light\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_1_2_014_pre\"")
