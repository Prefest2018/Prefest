...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Box\")")
...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().resourceId(\"com.money.manager.ex:id/editTextTransNumber\").className(\"android.widget.EditText\")")
	element.clear()
	element.send_keys("");
	element = getElememt(driver, "new UiSelector().resourceId(\"com.money.manager.ex:id/editTextTransNumber\").className(\"android.widget.EditText\")")
	element.clear()
