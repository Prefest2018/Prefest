...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Night\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Top: This Hour\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Restrict post count\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"50\")").click()
	driver.press_keycode(4)
