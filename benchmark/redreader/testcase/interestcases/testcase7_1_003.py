...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Light Blue\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Tablet Mode (two pane)\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Always (may look odd)\")").click()
