...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Night\")")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickInList(driver, "new UiSelector().text(\"View Comments\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Restrict post count\")")
	clickInList(driver, "new UiSelector().text(\"50\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_3_4_003_pre\"")
