...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Ultra Black\")").click()
	driver.press_keycode(4)
	scrollToFindElement(driver, "new UiSelector().text(\"Behaviour\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Use Internal Browser\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Use Internal Browser\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"Use Custom Tabs\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"3_000_pre\"")
