...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Green\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Hide Android status bar\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Behaviour\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Portrait\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Swipe down to refresh\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Swipe down to refresh\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"Default Post Sort\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Best\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Restrict post count\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"25\")").click()
	driver.press_keycode(4)
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"7_005_pre\"")
