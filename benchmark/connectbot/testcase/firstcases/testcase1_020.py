...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"2 minutes ago\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	...
	TouchAction(driver).long_press(element).release().perform()
	element = getElememtBack(driver, "new UiSelector().text(\"u0_a55@generic_x86:/ $u0_a55@generic_x86:/ $u0_a55@generic_x86:/ $u0_a55@generic_x86:/ $[F/system/bin/sh: [F: not found127|u0_a55@generic_x86:/ $ [5~\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
	TouchAction(driver).tap(element).perform()
	element = getElememt(driver, "new UiSelector().className(\"android.widget.TextView\").description(\"Paste\")")
	TouchAction(driver).long_press(element).release().perform()
