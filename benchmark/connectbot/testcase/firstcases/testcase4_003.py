...
try :
	...
	element.clear()
	element.send_keys("8");
	element = getElememtBack(driver, "new UiSelector().text(\"Use any unlocked key\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememt(driver, "new UiSelector().className(\"android.widget.ImageView\").instance(5)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"IBM1047\")", "new UiSelector().className(\"android.widget.TextView\")")
	TouchAction(driver).tap(element).perform()
