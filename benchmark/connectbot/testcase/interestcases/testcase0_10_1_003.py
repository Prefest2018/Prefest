...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Force landscape\")")
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"1_003_pre\"")
...
try :
	...
	element = getElememt(driver, "new UiSelector().className(\"android.widget.ImageButton\").description(\"Navigate up\")")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"15 minutes ago\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"DEL Key\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Use any unlocked key\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
	...
	element = getElememt(driver, "new UiSelector().resourceId(\"org.connectbot:id/quickconnect_field\").className(\"android.widget.EditText\")")
	element.clear()
	...
	element.clear()
	element.send_keys("40");
	element = getElememtBack(driver, "new UiSelector().text(\"Use pubkey authentication\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Use any unlocked key\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Use pubkey authentication\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Encoding\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
