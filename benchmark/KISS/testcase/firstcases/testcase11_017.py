...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Keep history as-is until unchecked\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
	TouchAction(driver).tap(element).perform()
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"11_017\"")
