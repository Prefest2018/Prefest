...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Dev Tools\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Dev Settings\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"View or edit your excluded from history apps\")", "new UiSelector().className(\"android.widget.TextView\").instance(11)")
	TouchAction(driver).tap(element).perform()
