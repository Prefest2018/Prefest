...
try :
	...
	scrollToClickElement(driver, "new UiSelector().text(\"Max number of results in search and history\")")
	typeText(driver,"0")
	conscript(driver)
	...
	clickInList(driver, "new UiSelector().text(\"Dark semi-transparent theme\")")
	conscript(driver)
	...
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"0_1_2_028_pre\"")
