...
try :
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Dark semi-transparent theme\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Transparent search bar\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Transparent search bar\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Transparent favorites bar\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Transparent favorites bar\")", "false")
	scrollToFindElement(driver, "new UiSelector().text(\"Bigger search bar\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Bigger search bar\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Rounded list corners\")").click()
	clickoncheckable(driver, "new UiSelector().text(\"Rounded list corners\")", "true")
	scrollToFindElement(driver, "new UiSelector().text(\"Rounded bar corners\")").click()
	...
	scrollToFindElement(driver, "new UiSelector().text(\"Hide the KISS circle\")").click()
	...
	driver.press_keycode(4)
	scrollToFindElement(driver, "new UiSelector().text(\"Customize tags menu\")").click()
	scrollToFindElement(driver, "new UiSelector().text(\"Add tags in menu\")").click()
	...
	os.popen("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"2_006_pre\"")
...
try :
	...
	element = getElememtBack(driver, "new UiSelector().text(\"Search Google for “12”\")", "new UiSelector().className(\"android.widget.TextView\")")
	...
	endtime = time.time()
	print 'consumed time:', str(endtime - starttime), 's'
	command("adb shell am broadcast -a com.example.pkg.END_EMMA --es name \"2_006\"")
	jacocotime = time.time()
	print 'jacoco time:', str(jacocotime - endtime), 's'
	driver.quit()
