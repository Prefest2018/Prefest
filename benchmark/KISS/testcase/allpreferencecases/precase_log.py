...
try :
	...
	clickInList(driver, "new UiSelector().text(\"Accessed frequently recently\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Freeze history\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Freeze history\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Show incoming calls in history\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show incoming calls in history\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Show newly installed apps in history\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show newly installed apps in history\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickInList(driver, "new UiSelector().text(\"AMOLED dark theme\")")
	scrollToClickElement(driver, "new UiSelector().text(\"Display notification icons in black\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Display notification icons in black\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Transparent search bar\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Transparent search bar\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Transparent favorites bar\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Transparent favorites bar\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Bigger search bar\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Bigger search bar\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Rounded list corners\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Rounded list corners\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Rounded bar corners\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Rounded bar corners\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Show history on touch\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Hide favorites bar\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Hide favorites bar\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Hide navbar\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Hide navbar\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Hide the KISS circle\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Force portrait mode\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Force portrait mode\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Emulate drag event for wallpaper\")", "true")
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Center wallpaper\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Side stick wallpaper\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Side stick wallpaper\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Add tags in menu\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Show untagged action\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Show untagged action\")", "true")
	scrollToClickElement(driver, "new UiSelector().text(\"Close tags menu after selection\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Close tags menu after selection\")", "true")
	time.sleep(1)
	driver.press_keycode(4)
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Contacts\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Device settings\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Device settings\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Shortcuts\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Shortcuts\")", "false")
	scrollToClickElement(driver, "new UiSelector().text(\"Web search\")")
	clickOnCheckable(driver, "new UiSelector().text(\"Web search\")", "false")
	time.sleep(1)
	driver.press_keycode(4)
	...
	clickOnCheckable(driver, "new UiSelector().text(\"Root mode\")", "true")
