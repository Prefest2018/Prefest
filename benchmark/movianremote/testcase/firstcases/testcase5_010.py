...
try :
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"EnableScreenSaver\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(3)")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"Increase\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(4)")
	TouchAction(driver).tap(element).perform()
	...
	TouchAction(driver).tap(element).perform()
	element = getElememtBack(driver, "new UiSelector().text(\"MoveRight\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(5)")
	TouchAction(driver).tap(element).perform()
except Exception, e:
	print 'FAIL'
	print 'str(e):\t\t', str(e)
